...
public class PagerIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.pagerIndicatorStyle);
    }
    ...
    public PagerIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDrawable = a.getDrawable(R.styleable.PagerIndicator_android_drawable);
        mSpacing = a.getDimensionPixelSize(R.styleable.PagerIndicator_android_spacing, 0);
        mTransition = a.getInt(R.styleable.PagerIndicator_transition, TRANSITION_FADE);
        if (mTransition == TRANSITION_FADE) {
            mFromAlpha = a.getFloat(R.styleable.PagerIndicator_fromAlpha, 0.5f);
            mToAlpha = a.getFloat(R.styleable.PagerIndicator_toAlpha, 1.0f);
        } else if (mTransition == TRANSITION_SCALE) {
            mFromScaleX = a.getFloat(R.styleable.PagerIndicator_fromScaleX, 0.5f);
            mFromScaleY = a.getFloat(R.styleable.PagerIndicator_fromScaleY, 0.5f);
            mToScaleX = a.getFloat(R.styleable.PagerIndicator_toScaleX, 1.0f);
            mToScaleY = a.getFloat(R.styleable.PagerIndicator_toScaleY, 1.0f);
        }
        a.recycle();
