 ...
 */
public class JdxCsvFormatStrategy implements FormatStrategy {
    ...
    private JdxCsvFormatStrategy(@NonNull Builder builder) {
        orhanobutUtils.checkNotNull(builder);
    ...
    public static final class Builder {
        ...
        @NonNull
        public JdxCsvFormatStrategy build() {
            if (date == null) {
                date = new Date();
            }
            if (dateFormat == null) {
            ...
            if (logStrategy == null) {
                ...
                ht.start();
                Handler handler = new JdxDiskLogStrategy.WriteHandler(ht.getLooper(), folder, MAX_BYTES);
                logStrategy = new JdxDiskLogStrategy(handler);
            }
            return new JdxCsvFormatStrategy(this);
        }
    }
}
