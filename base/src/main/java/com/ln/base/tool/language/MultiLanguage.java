...
public class MultiLanguage {
    ...
    public static Context setLocal(Context context) {
        return updateResources(context, getSelectLanguageLocale(context));
    }
    ...
    public static void setApplicationLanguage(Context context) {
        ...
        Locale locale = getSelectLanguageLocale(context);
    ...
    public static Locale getSelectLanguageLocale(Context context) {
        if (languageLocalListener != null) {
            return languageLocalListener.getSelectLanguageLocale(context);
        }
