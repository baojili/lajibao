...
public class PickPhotoBottomDialog extends BottomDialog {
    ...
    public PickPhotoBottomDialog(BaseActivity context, Integer requestCode) {
        this(context, null, requestCode);
    }

    public PickPhotoBottomDialog(BaseActivity context, String title) {
        this(context, title, null);
    }

    public PickPhotoBottomDialog(BaseActivity context) {
        this(context, null, null);
    }

    public PickPhotoBottomDialog(BaseActivity context, String title, Integer requestCode) {
        super(context);
    ...
    public void show(Integer requestCode) {
        this.requestCode = requestCode;
        super.show();
    }
